import { cloneDeep } from "../domain/clone.js?v=20260706-5";
import {
  PAPER_SIZES,
  PAPER_MARGINS,
  PDF_COURSE_SCOPES,
...
import { courseHasVariations, relayEntryLabel, relayVariationForLeg, variationForCode } from "../domain/relay-variations.js?v=20260706-5";
import { t } from "./i18n.js?v=20260706-5";
import { safeFilePart } from "./app-shell-pdf-helpers.js?v=20260706-5";
import { pdfDataUrlLooksLikePdf } from "./app-shell-resource-helpers.js?v=20260706-5";
