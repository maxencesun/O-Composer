import { Store } from "../state/store.js?v=20260630-3";
import {
  acceptCookieConsent,
  hasCookieConsent,
  ...
  saveCachedSession
} from "../state/cookie-cache.js?v=20260630-3";
import { parseOmap } from "../domain/omap-parser.js?v=20260630-3";
import { parsePpen, serializeNativePpen, serializeOcp, serializePpen } from "../domain/ppen-parser.js?v=20260630-3";
import {
  CONTROL_KINDS,
  cloneEvent,
  createBlankEvent,
  findById
} from "../domain/event-model.js?v=20260630-3";
import {
  addControlAt,
...
} from "../domain/actions.js?v=20260630-3";
import {
  DESCRIPTION_KINDS,
  ISCD_COLUMNS,
...
} from "../domain/control-descriptions.js?v=20260630-3";
import {
  PRINT_AREA_SCOPES,
  effectivePrintArea,
  normalizePrintArea,
  ...
  setPrintArea
} from "../domain/print-area.js?v=20260630-3";
import { createVectorMapPdfBlob } from "../domain/pdf-exporter.js?v=20260630-3";
import { isPdfFile, renderPdfBasemap } from "../domain/pdf-basemap.js?v=20260630-3";
import {
  allControlsView,
  controlKindLabel,
...
} from "../domain/exporters.js?v=20260630-3";
import {
...
import {
  ...
  variationForCode
} from "../domain/relay-variations.js?v=20260630-3";
import { SUPPORTED_LANGUAGES, getLanguage, optionLabel, setLanguage, t } from "./i18n.js?v=20260630-3";
import { iconSvg } from "./icons.js?v=20260630-3";
import { MapView } from "./map-view.js?v=20260630-3";
import { createAppShellTemplateMethods } from "./app-shell-template-methods.js?v=20260630-3";
import { createAppShellMenuMethods } from "./app-shell-menu-methods.js?v=20260630-3";
import { createAppShellCoursePanelMethods } from "./app-shell-course-panel-methods.js?v=20260630-3";
import { createAppShellVariationMethods } from "./app-shell-variation-methods.js?v=20260630-3";
import { createAppShellSelectionEditorMethods } from "./app-shell-selection-editor-methods.js?v=20260630-3";
import { createAppShellCommandMethods } from "./app-shell-command-methods.js?v=20260630-3";
import { createAppShellFileExportMethods } from "./app-shell-file-export-methods.js?v=20260630-3";
import { createAppShellDialogMethods } from "./app-shell-dialog-methods.js?v=20260630-3";
import { createAppShellPrintCourseDialogMethods } from "./app-shell-print-course-dialog-methods.js?v=20260630-3";
import {
  RENDER_QUALITIES,
  isRenderQualityId,
...
} from "./render-quality.js?v=20260630-3";
import { hasCompletedMetaSetup, saveMetaSetupPreference } from "./app-meta-setup.js?v=20260630-3";
...
} from "./app-shell-config.js?v=20260630-3";
import {
  ...
  escapeHtml,
  escapeAttr
} from "./app-shell-helpers.js?v=20260630-3";
