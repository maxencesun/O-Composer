import { debugLog, debugWarn, debugError } from "./debug-log.js?v=20260701-15";
export function createMapViewOmapMethods(deps) {
  ...
  ensureOmapWorker() {
    ...
    try {
      const worker = new Worker(new URL("../workers/omap-render-worker.js?v=20260701-15", import.meta.url), { type: "module" });
