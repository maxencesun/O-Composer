import { cloneDeep } from "../domain/clone.js?v=20260701-5";
import {
  PAPER_SIZES,
  PAPER_MARGINS,
  PDF_COURSE_SCOPES,
...
import { saveCachedPdfBasemap } from "../state/cookie-cache.js?v=20260701-5";
import { escapeAttr, escapeHtml } from "./app-shell-ui-helpers.js?v=20260701-5";
import { findById } from "../domain/event-model.js?v=20260701-5";
import {
...
import { PRINT_AREA_SCOPES, effectivePrintArea, normalizePrintArea } from "../domain/print-area.js?v=20260701-5";
import {
  controlKindLabel,
...
import { courseHasVariations, relayEntryLabel, relayVariationForLeg, variationForCode } from "../domain/relay-variations.js?v=20260701-5";
import { t } from "./i18n.js?v=20260701-5";
import { safeFilePart } from "./app-shell-pdf-helpers.js?v=20260701-5";
import { pdfDataUrlLooksLikePdf } from "./app-shell-resource-helpers.js?v=20260701-5";
