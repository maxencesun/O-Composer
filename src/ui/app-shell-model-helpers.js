import { cloneDeep } from "../domain/clone.js?v=20260715-39";
import {
  PAPER_SIZES,
  PAPER_MARGINS,
  PDF_COURSE_SCOPES,
...
import { saveCachedPdfBasemap } from "../state/cookie-cache.js?v=20260715-39";
import { escapeAttr, escapeHtml } from "./app-shell-ui-helpers.js?v=20260715-39";
import { findById } from "../domain/event-model.js?v=20260715-39";
import {
...
import { PRINT_AREA_SCOPES, effectivePrintArea, normalizePrintArea } from "../domain/print-area.js?v=20260715-39";
import {
  controlKindLabel,
...
import { allCourseVariations, courseHasVariations, relayEntryLabel, relayVariationForLeg, variationForCode } from "../domain/relay-variations.js?v=20260715-39";
import { t } from "./i18n.js?v=20260715-39";
import { safeFilePart } from "./app-shell-pdf-helpers.js?v=20260715-39";
import { pdfDataUrlLooksLikePdf } from "./app-shell-resource-helpers.js?v=20260715-39";
