...
def verify_app_files() -> None:
    ...
    assert 'export const APP_CODE_VERSION = "20260713-24"' in app_config, "browser modules should use the current code cachebuster"
