const CONSENT_COOKIE = "oComposerCookieConsent";
const CACHE_META_COOKIE = "oComposerSessionCache";
const LEGACY_CHUNK_PREFIX = "oComposerSessionCache.";
const LEGACY_STORAGE_KEY = "oComposerSessionCachePayload";
const COOKIE_DAYS = 180;
const DB_NAME = "oComposerWebCache";
const DB_VERSION = 2;
