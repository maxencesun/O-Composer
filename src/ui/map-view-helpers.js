...
import { descriptionBounds, drawControlDescriptionBlock } from "../domain/control-descriptions.js?v=20260713-23";
import { resolveTextConstants } from "../domain/constants.js?v=20260713-23";
