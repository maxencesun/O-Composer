...
} from "../domain/control-descriptions.js?v=innerTest-20260621-9";
import {
  PRINT_AREA_SCOPES,
  effectivePrintArea,
  normalizePrintArea,
...
import { SUPPORTED_LANGUAGES, getLanguage, optionLabel, setLanguage, t } from "./i18n.js?v=innerTest-20260621-9";
import { iconSvg } from "./icons.js";
import { MapView } from "./map-view.js";
import { createAppShellTemplateMethods } from "./app-shell-template-methods.js";
import { createAppShellMenuMethods } from "./app-shell-menu-methods.js?v=innerTest-20260621-9";
import { createAppShellCoursePanelMethods } from "./app-shell-course-panel-methods.js?v=innerTest-20260621-9";
import { createAppShellVariationMethods } from "./app-shell-variation-methods.js?v=innerTest-20260621-9";
import { createAppShellSelectionEditorMethods } from "./app-shell-selection-editor-methods.js?v=innerTest-20260621-9";
import { createAppShellCommandMethods } from "./app-shell-command-methods.js?v=innerTest-20260621-9";
import { createAppShellFileExportMethods } from "./app-shell-file-export-methods.js?v=innerTest-20260621-9";
