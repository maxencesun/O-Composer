import { debugLog, debugWarn, debugError } from "./debug-log.js?v=20260711-4";
export function createMapViewOmapMethods(deps) {
  ...
  ensureOmapWorker() {
    ...
    try {
      const worker = new Worker(new URL("../workers/omap-render-worker.js?v=20260711-4", import.meta.url), { type: "module" });
